...
public class AISummarizeConfigProperties {
    ...
    private AISummarizeConfigProperties() {
        // only static stuff
    }
    ...
    public static List<PropertyDefinition> all() {
        return List.of(
                ...
                PropertyDefinition.builder(AiSummarizeConfig.AI_PROVIDER)
                        ...
                        .index(1)
                        .build(),
                PropertyDefinition.builder(AiSummarizeConfig.AI_MODEL)
                        .name("AI Model")
                ...
                PropertyDefinition.builder(AiSummarizeConfig.AI_CLIENT_API_KEY)
                ...
                PropertyDefinition.builder(AiSummarizeConfig.AI_PROMPT_TEMPLATE)
